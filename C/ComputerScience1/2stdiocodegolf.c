...
int main( int argc, char *argv[] )
{
        ...
        while (  fgets( buff, 50, stdin ) )
	   {
			...
			if ( nomoreaccounts == 0 )
			{
                ...
                int tmpan[20], tmpabpre[20], tmpabpost[20], numdigitsan = 0, i = 0, numdigitsab = 0, m = 0;
			...
			else if ( nomoreaccounts == 1 )
			{
				...
				for ( k = 0; k < strlen(buff); k++ )
                {
                int tmpan[20] = {0}, tmpab[20] = {0}, tmpbalancepre[20] = {0}, tmpbalancepost[20] = {0}, numdigitsab = 0, numdigitsan = 0, i = 0, numdigitsabpre = 0, numdigitsabpost = 0, m = 0;
